...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Departamentos o categor\u00EDas de productos';
  ...
  attributes: {
    ...
    subDepartments: Schema.Attribute.Relation<
      'oneToMany',
      'api::department.department'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Facturas de las \u00F3rdenes';
    displayName: 'Invoice';
    pluralName: 'invoices';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customerInfo: Schema.Attribute.JSON & Schema.Attribute.Required;
    discount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    subtotal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    tax: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    taxRate: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<19>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Items de las \u00F3rdenes';
  ...
  attributes: {
    ...
    productSnapshot: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paymentDetails: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
    paymentMethod: Schema.Attribute.Enumeration<
      ['wompi', 'nequi', 'cash', 'transfer']
    > &
      Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    trackInventory: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStoreConfigStoreConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    activeTheme: Schema.Attribute.Relation<'oneToOne', 'api::theme.theme'>;
    ...
    description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Descubre nuestra exclusiva colecci\u00F3n de bolsos de dise\u00F1ador'>;
    ...
    storeName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'AdaraStyle'>;
    storeSlug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.DefaultTo<'adarastyle'>;
    tagline: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Bolsos de lujo para mujeres excepcionales'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Temas visuales para la tienda';
    displayName: 'Theme';
    pluralName: 'themes';
    singularName: 'theme';
  };
  ...
  attributes: {
    animations: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        duration: '0.3s';
        easing: 'ease-in-out';
      }>;
    borderRadius: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        full: '9999px';
        lg: '12px';
        md: '8px';
